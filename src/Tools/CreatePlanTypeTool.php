                ...
                'rows' => [
                    ...
                    'items' => [
                        ...
                        'properties' => [
                            ...
                            'time_agg' => ['type' => 'string', 'enum' => ['flow', 'stock', 'stock_open', 'avg', 'recompute'], 'description' => 'Zeit-Aggregation: flow (Default, summiert über die Zeit — Umsatz/Kosten) · stock (Bestand, Schlusswert = jüngster Teilzeitraum — Personal/Bestand/Cash/Schulden; Q1=März, nicht Σ) · stock_open (Eröffnungswert) · avg (Durchschnitt). '
